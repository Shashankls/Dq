...
SHORTLINK_API = environ.get('SHORTLINK_API', '11425ee8d4f834256b5a66c1fbbc498caff71ad9')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'false')), false)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+l9YAk8zRgldhYWNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+zskDMEHvYKg4NDRl')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+l9YAk8zRgldhYWNl')
