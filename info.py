...
SUPPORT_CHAT_ID = str(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'sharedisk.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'e26eadf7050fc1af0ce5d082d40d78c6c013984c')
...
'https://t.me/+l9YAk8zRgldhYWNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+zskDMEHvYKg4NDRl')
